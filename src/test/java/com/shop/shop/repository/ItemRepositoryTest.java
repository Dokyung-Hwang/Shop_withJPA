...
class ItemRepositoryTest {
    ...
    @Test
    @DisplayName("상품명 or 상품상세설명 으로 조회 테스트")
    ...
    public void queryDslTest() {
        ...
        List<Item> itemList = query.fetch();        // fetch() 메서드 실행 시점에 쿼리문이 실행
    ...
    public void queryDslTest2() {
        ...
        BooleanBuilder booleanBuilder = new BooleanBuilder();   // query에 들어갈 조건을 만들어주는 빌더 Predicate를 구현, 메소드 체인 형식으로 사용
